...
import { activateDeal, confirmPayment, markRefunded } from '@/app/dashboard/deals/[id]/orders/actions';
      ...
      {!orders || orders.length === 0 ? (
        ...
        <div className="space-y-3">
          {orders.map((order: any) => {
            const confirmWithId = confirmPayment.bind(null, order.id);
            const refundWithId = markRefunded.bind(null, order.id);
            return (
